...
export const symptomGroups = [
  {
    ...
    symptoms: [
      ...
      { label: 'Yellow or mustard dust', category: 'problems', slug: 'mustard-algae-in-pool' },
      { label: 'Stains on the plaster', category: 'problems', slug: 'pool-stains-identification' },
