...
export const SCHEMA = {
  ...
  // Ported from lawncarehq ARTICLE_STANDARDS.md: the shape is chosen before writing
  // and recorded so the choice is reviewable. Diagnostic | Explainer | Project |
  // Timing | Comparison | Profile.
  archetype: { type: 'string', required: false, default: null },
