 ...
 * climate, which is why every entry also names the products that season needs.
 *
...
const SEASONS = {
  spring: {
    key: 'spring',
    shop: {
      primary: { href: '/winterizing', label: 'Opening kits & start-up chems' },
      secondary: { href: '/test-kits', label: 'Test kits' },
    },
  ...
  summer: {
    key: 'summer',
    shop: {
      primary: { href: '/algaecides-treatments', label: 'Algaecides & clarifiers' },
      secondary: { href: '/pool-cleaners', label: 'Robotic cleaners' },
    },
    label: 'Peak season',
  ...
  fall: {
    key: 'fall',
    shop: {
      primary: { href: '/winterizing', label: 'Closing kits & antifreeze' },
      secondary: { href: '/pool-covers', label: 'Winter covers' },
    },
  ...
  winter: {
    key: 'winter',
    shop: {
      primary: { href: '/pool-covers', label: 'Cover pumps & covers' },
      secondary: { href: '/pool-pumps', label: 'Replacement pumps' },
    },
    label: 'Off season',
