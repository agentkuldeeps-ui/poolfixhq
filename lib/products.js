...
export const products = [
  {
    id: 'cleaner-shoes',
    title: 'Suction Cleaner Shoes / Pads',
    summary: 'The replaceable traction pads a suction cleaner walks on. Among the cheapest parts on the fault list and the one most often overlooked.',
    constraint: 'Surface-specific — Hayward specifies standard or slotted for plaster and Pebble-Tec, cork for vinyl and fiberglass, ceramic for tile. Match the shoe to your surface and to your cleaner model; the wrong one slips even when it fits.',
    category: 'parts',
  },
  {
    id: 'enzyme-cleaner',
